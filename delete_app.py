...
r5 = requests.get('https://qa.fortidevsec.forticloud.com/api/v1/dashboard/get_orgs',headers=headers_details,verify=False)
#print (r5.json())
...
headers_details={'Authorization': r4_data['token_type'] + ' ' + r4_data['access_token'],'accept':r4.headers['Content-Type']}
r6 = requests.get('https://qa.fortidevsec.forticloud.com/api/v1/dashboard/get_apps', headers=headers_details, params = params_data, verify=False)
print (r6.json())
...
for x in range(appCount):
    ...
    print("app_id",app_id)
    r7 = requests.post('https://qa.fortidevsec.forticloud.com/api/v1/dashboard/delete_app', headers=headers_details, params = {'app_id':app_id}, verify=False)
    #print (r7.text)
