...
for x in range(create_apps):
    try:
        ...
        client.images.pull('qaregistry.fortinet.com/fortidevsec/fdevsec_sast:latest')

        container=client.containers.run('qaregistry.fortinet.com/fortidevsec/fdevsec_sast:latest',remove=False,extra_hosts={'qa.fortidevsec.forticloud.com':fdevsec_dashboard_ip},volumes={pwd : {'bind': '/scan', 'mode': 'rw'}},detach=True)
